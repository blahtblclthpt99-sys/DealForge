...
Every new Checkout creation re-runs the activation assessment against the current server-stored product record before creating or resuming an order. Checkout therefore fails closed when:
