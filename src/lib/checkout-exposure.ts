...
// Pilot limits deliberately constrain the amount DealForge can become obligated
// to source through one unpaid Checkout Session. Raise only through reviewed code.
