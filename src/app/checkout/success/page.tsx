  ...
  return (
    <main className="mx-auto flex min-h-[60vh] max-w-2xl flex-col justify-center px-6 py-16">
      ...
      <p className="mt-4 text-base leading-7 text-zinc-600">
        DealForge confirms payment directly with Stripe before an order is released for sourcing or
        fulfillment. This page does not mark an order as paid.
      </p>
      <p className="mt-3 text-sm leading-6 text-zinc-500">
        If confirmation is still processing, your order remains safely pending until Stripe sends a
