    ...
    <div>
      <section className="relative overflow-hidden border-b border-card-border">
        ...
        <div className="dn-container relative grid items-center gap-10 py-16 md:grid-cols-[1.1fr_0.9fr] md:py-24">
          ...
          <div className="relative animate-fade-up hidden md:block" style={{ animationDelay: "120ms" }}>
              ...
              <div className="relative space-y-4">
                ...
                <div className="flex items-center gap-3 rounded-2xl bg-forest/10 p-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-forest-muted">We route you to stores — we never sell stock</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="border-y border-card-border bg-card/50 py-14">
        <div className="dn-container">
          <SectionHeader
            ...
            subtitle="Browse every aisle of the nest"
            href="/categories"
          />
      ...
      <section className="dn-container py-14">
        <SectionHeader title="Trending Products" subtitle="What shoppers are clicking now" href="/search?sort=popularity" />
        <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-4">
      ...
      <section className="dn-container py-14">
        <SectionHeader title="New Arrivals" subtitle="Fresh finds just nested" href="/search?sort=newest" />
        <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-4">
          {newest.items.map((p) => (
            <ProductCard key={p.id} product={p} />
          ))}
      ...
      <section className="dn-container pb-16 pt-6">
        <SectionHeader title="All Deals" subtitle="Keep scrolling — more nest every day" />
