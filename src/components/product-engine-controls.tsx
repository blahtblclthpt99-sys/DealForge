      ...
      <section id="commercial-gate" className="dn-card mt-6 min-w-0 scroll-mt-6 overflow-hidden p-5">
        ...
        {products.length ? (
          <form onSubmit={commercialize} className="mt-5 grid min-w-0 gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <p className="text-xs text-forest-muted sm:col-span-2 lg:col-span-3">The default tax code is only a starting value. Confirm the exact Stripe Product Tax Code for the selected product before submitting; this evidence is timestamped and becomes part of the product's immutable checkout authority.</p>
